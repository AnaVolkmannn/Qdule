      ...
      <div className="w-full max-w-md flex flex-col gap-6">
        ...
        <div className="grid w-full gap-4 bg-white/60 p-6 rounded-2xl shadow-lg border border-pink-100">
          <div className="flex flex-col gap-5">
            ...
            <div className="rounded-xl px-6 flex flex-row items-center justify-center gap-2 bg-secondary py-4">
              ...
              <div className="flex items-center">
                <h2 className="font-bold text-sm text-white!">{horario}h</h2>
              </div>
            </div>

            <div className="pt-2">
              <p className="text-sm text-center font-bold text-accent mb-4">
              ...
              <div className="flex items-start space-x-3 bg-muted/30 p-4 rounded-lg border border-border">
                <Checkbox
                  id="termos"
                  className="mt-1 border-ring data-[state=checked]:bg-secondary data-[state=checked]:border-ring cursor-pointer"
                />
                <Label
                  htmlFor="termos"
              ...
              <Button
                className="w-full bg-button hover:bg-buttonhover text-white rounded-xl h-12 cursor-pointer"
